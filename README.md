...
| **H.265 (HEVC) cameras** | ❌ Not available: H.265 cameras are added as RTSP/UDP sources, which the browser cannot open | ✅ Plays on every platform, and recordings are re-encoded so they can be saved |
