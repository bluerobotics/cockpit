...
export const useVideoStore = defineStore('video', () => {
  ...
  const resumeRecordingWhenStreamReturns = (
    ...
    // The snackbar is gone in five seconds, so the alert is what is left to tell the operator later why a take of
    ...
    openSnackbar({ message: dropped, duration: 5000, variant: 'info' })
  }
