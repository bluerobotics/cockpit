...
export const defaultMessageFrequency = {
  ...
  [MAVLinkType.NAMED_VALUE_FLOAT]: 2,
  ...
  [MAVLinkType.RPM]: 3,
  [MAVLinkType.ESC_TELEMETRY_1_TO_4]: 3,
  [MAVLinkType.ESC_TELEMETRY_5_TO_8]: 3,
  [MAVLinkType.ESC_TELEMETRY_9_TO_12]: 3,
