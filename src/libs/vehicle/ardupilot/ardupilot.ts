...
export abstract class ArduPilotVehicle<Modes> extends Vehicle.AbstractVehicle<Modes> {
  ...
  requestDefaultMessages(): void {
    ...
    messagesWithIntervals.forEach((message) => {
      this.sendCommandLong(MavCmd.MAV_CMD_SET_MESSAGE_INTERVAL, message.id, message.intervalUs)
    })
  }
