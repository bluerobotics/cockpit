  ...
  <BaseConfigurationView>
    <template #help-icon>
      <GlassButton
        ...
        :icon-size="interfaceStore.isOnSmallScreen ? 16 : 24"
        :icon-class="interfaceStore.isOnSmallScreen ? '-ml-[1px]' : ''"
        variant="round"
...
const openHelpDialog = (): void => {
  showDialog({
    title: 'General Configuration Help',
    message: [
      // eslint-disable-next-line vue/max-len
      'Global Vehicle Address: Sets the network address for device communication. Change and apply new settings as needed.',
      // eslint-disable-next-line vue/max-len
      'Mavlink2Rest Connection: Configures MAVLink over HTTP/WS. Toggle to enable/disable and apply settings to take effect.',
      // eslint-disable-next-line vue/max-len
      'WebRTC Connection: Establishes real-time communication over the web. Set the signaling server URI and toggle to activate.',
