...
const translateEventCategory = (category: string): string => {
  const mapping: Record<string, string> = {
    'Arm': t('configuration.mission.arm'),
    'Disarm': t('configuration.mission.disarm'),
    'Takeoff': t('configuration.mission.takeoff'),
    'Altitude Change': t('configuration.mission.altitudeChange'),
    'Land': t('configuration.mission.land'),
    'Goto': t('configuration.mission.goto'),
  }
