          ...
          <template #content>
            <div class="flex justify-between">
              <v-switch
                ...
                :label="$t('configuration.alerts.enableVoiceAlerts')"
                color="white"
                class="ml-3"
              />
              <v-slider
...
const translateAlertLevel = (level: string): string => {
  const mapping: Record<string, string> = {
    info: t('configuration.alerts.info'),
    success: t('configuration.alerts.success'),
    error: t('configuration.alerts.error'),
    warning: t('configuration.alerts.warning'),
    critical: t('configuration.alerts.critical'),
  }
