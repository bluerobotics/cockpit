<template>
  ...
  <v-dialog v-model="actionDialog.show" max-width="500px">
    <v-card class="rounded-lg p-3" :style="interfaceStore.globalGlassMenuStyles">
      ...
      <v-card-actions class="pa-2">
        <v-spacer></v-spacer>
        <v-btn color="primary" variant="text" size="small" @click="closeActionDialog">Cancel</v-btn>
        <v-btn color="error" variant="text" size="small" @click="resetNewAction">Discard</v-btn>
        <v-btn color="primary" :disabled="!isFormValid" size="small" @click="saveActionConfig">
  ...
  <v-dialog v-model="urlParamDialog.show" max-width="400px">
    <v-card class="rounded-lg p-3" :style="interfaceStore.globalGlassMenuStyles">
      ...
      <v-card-actions class="pa-2">
        <v-spacer></v-spacer>
        <v-btn color="primary" variant="text" size="small" @click="closeUrlParamDialog">Cancel</v-btn>
        <v-btn color="primary" size="small" @click="saveUrlParameter()"> " > Save </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
  ...
  <v-dialog v-model="headerDialog.show" max-width="400px">
    <v-card class="rounded-lg p-3" :style="interfaceStore.globalGlassMenuStyles">
      ...
      <v-card-actions class="pa-2">
        <v-spacer></v-spacer>
        <v-btn color="primary" variant="text" size="small" @click="closeHeaderDialog">Cancel</v-btn>
        <v-btn color="primary" size="small" @click="addHeader">Save</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
  ...
  <v-dialog v-model="bodyDialog.show" max-width="400px">
    <v-card class="rounded-lg p-3" :style="interfaceStore.globalGlassMenuStyles">
      ...
      <v-card-actions class="pa-2">
        <v-spacer></v-spacer>
        <v-btn color="primary" variant="text" size="small" @click="closeJsonDialog">Cancel</v-btn>
        <v-btn color="primary" :disabled="!bodyDialog.isValid" size="small" @click="saveJsonBody">Save</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
