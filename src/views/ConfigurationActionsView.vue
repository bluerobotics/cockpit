<template>
  <BaseConfigurationView>
    <template #title>{{ $t('configuration.actions.cockpitActionsConfiguration') }}</template>
    <template #content>
        ...
        <v-dialog v-model="actionTypeDialog.show" max-width="400px">
          <v-card class="rounded-lg" :style="interfaceStore.globalGlassMenuStyles">
            <v-card-title class="text-h6 font-weight-bold py-4 text-center">{{
              $t('configuration.actions.selectActionType')
            }}</v-card-title>
...
const translateActionType = (type: customActionTypes): string => {
  const typeMap: Record<customActionTypes, string> = {
    [customActionTypes.httpRequest]: t('configuration.actions.actionTypes.httpRequest'),
    [customActionTypes.mavlinkMessage]: t('configuration.actions.actionTypes.mavlinkMessage'),
    [customActionTypes.javascript]: t('configuration.actions.actionTypes.javascript'),
  }
