      ...
      <div class="max-h-[85vh] overflow-y-auto">
        <ExpansiblePanel no-top-divider no-bottom-divider :is-expanded="!interfaceStore.isOnPhoneScreen">
          ...
          <template #content>
                ...
                >
                  <template #item="{ item }">
                    <tr>
                      ...
                      <td>
                        <div class="flex flex items-start justify-center rounded-xl mx-1 w-[400px] py-2">
                          <v-select
                          ...
                          />
                          <div class="flex items-center w-full mt-1 ml-4">
                            <v-slider
                              v-model="item.frequency"
                              color="white"
                              class="mt-1 scale-90 w-[110px]"
                              min="1"
                              step="1"
                              max="50"
                              hide-details
            ...
            <div class="flex w-full">
              <v-card
                class="flex flex-col w-full mx-4 px-4 pt-3 mb-6 elevation-1 bg-transparent rounded-lg"
                theme="dark"
                :style="interfaceStore.globalGlassMenuStyles"
              >
                <span class="text-sm text-gray-200 mb-3">Set the interval for a new message</span>
                <div class="flex flex-row items-end gap-4 w-full mb-4">
                  <v-select
...
const headers = [
  ...
  { title: 'Configuration', key: 'configuration', align: 'start' },
]
