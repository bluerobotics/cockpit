<template>
      ...
      <div class="flex-col h-full ml-[1vw] w-[920px] max-h-[85vh] overflow-y-auto pr-3">
        ...
        <ExpansiblePanel no-bottom-divider :is-expanded="!interfaceStore.isOnPhoneScreen">
          ...
          <template #info>
            {{
              $t(
                'Configure live video processing to process videos in real-time during recording for instant availability when recording stops. This is only available in the Electron (desktop) version.'
              )
            }}
            <br /><br />
            {{
          ...
          <template #content>
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-amber-100 text-sm">
                    {{
                      $t(
                        'Video processing is not available in the browser version. Your recordings will be saved as raw chunks that can be downloaded and processed using the standalone version of Cockpit.'
                      )
                    }}
                  </p>
                </div>
            ...
            <div class="flex items-center justify-start w-[96%] ml-2">
              <v-checkbox
                ...
                :label="$t('Live video processing (Electron)')"
                class="text-sm mx-2"
                hide-details
                :disabled="!isElectron()"
              />
              <v-tooltip
                :text="
                  isElectron()
                    ...
                    : $t('Live video processing is only available in the standalone version')
                "
              >
            ...
            <div class="flex items-center justify-start w-[96%] ml-2">
              ...
              <v-tooltip max-width="400px">
                ...
                <div class="text-sm">
                  ...
                  <p class="mt-2 text-gray-300">
                    {{ $t('For the browser version the chunks are always saved by default.') }}
                  </p>
                </div>
              </v-tooltip>
            </div>
  ...
  <InteractionDialog
    ...
    :persistent="true"
    :actions="[
      { text: $t('Cancel'), size: 'small', action: cancelEditDialog },
