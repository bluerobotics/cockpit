<template>
  <div id="draggable-container" @dragover.prevent="handleDragOver">
    <BaseConfigurationView>
      ...
      <template #title
        ><div :class="interfaceStore.isOnPhoneScreen ? '' : 'mt-1'">
          {{ $t('components.TelemetryOverlay.title') }}
        </div></template
      >
      <template #content>
        <div
          ...
          >
            <div id="leftColumn" class="flex flex-col justify-start align-start mt-[2vh] overflow-auto">
              <ExpansiblePanel compact mark-expanded darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.overlayOptions') }}</template>
                <template #content>
                  <div>
                    <div class="flex flex-col flex-wrap justify-between align-start gap-y-0 pt-3">
                      <div class="flex flex-row justify-between align-center w-full gap-x-3">
                        <span
                          ...
                          >{{ $t('components.TelemetryOverlay.fontSize') }}</span
                        >
                        <v-text-field
                      ...
                      <div class="flex flex-row justify-between align-center w-full gap-x-3 -mt-2">
                        <span
                          class="font-bold text-white text-start mb-5"
                          :class="interfaceStore.isOnSmallScreen ? ' text-xs w-[75px]' : 'text-sm w-[125px]'"
                          >{{ $t('components.TelemetryOverlay.shadowSize') }}</span
                        >
                        <v-text-field
                          ...
                          >
                            <template #activator="{ props }">
                              <span
                                ...
                                >{{ $t('components.TelemetryOverlay.fontColor') }}</span
                              >
                              <div
                                v-bind="props"
                          ...
                          >
                            <template #activator="{ props }">
                              <span
                                :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                                class="text-sm font-bold text-white text-start"
                                >{{ $t('components.TelemetryOverlay.outlineColor') }}</span
                              >
                              <div
                                v-bind="props"
                                class="w-[20px] h-[20px] border-2 border-slate-600 rounded-full cursor-pointer"
                          ...
                          >
                            <template #activator="{ props }">
                              <span
                                :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                                class="text-sm font-bold text-white text-start"
                                >{{ $t('components.TelemetryOverlay.shadowColor') }}</span
                              >
                              <div
                                v-bind="props"
                                class="w-[20px] h-[20px] border-2 border-slate-600 rounded-full cursor-pointer"
                      ...
                      <div>
                        ...
                        >
                          ...
                          <span
                            ...
                            :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                            >{{ $t('components.TelemetryOverlay.bold') }}</span
                          >
                        </div>
                        <div
                          class="flex flex-row justify-start align-center -ml-2"
                        ...
                        >
                          ...
                          <span
                            class="text-sm font-bold text-white -mt-[20px] text-start"
                            :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                            >{{ $t('components.TelemetryOverlay.italic') }}</span
                          >
                        </div>
                        <div
                          class="flex flex-row justify-start align-center -ml-2"
                        ...
                        >
                          ...
                          <span
                            class="text-sm font-bold text-white -mt-[20px] text-start"
                            :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                            >{{ $t('components.TelemetryOverlay.underline') }}</span
                          >
                        </div>
                        <div
                          class="flex flex-row justify-start align-center -ml-2"
                        ...
                        >
                          ...
                          <span
                            class="text-sm font-bold text-white -mt-[20px] text-start"
                            :class="interfaceStore.isOnSmallScreen ? ' text-xs' : 'text-sm'"
                            >{{ $t('components.TelemetryOverlay.strikethrough') }}</span
                          >
                        </div>
                      </div>
                    </div>
              ...
              <ExpansiblePanel compact mark-expanded no-top-divider darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.vehicleVariables') }}</template>
                <template #content>
                  <VueDraggable
              ...
              <ExpansiblePanel compact mark-expanded no-top-divider darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.missionVariables') }}</template>
                <template #content>
                  <VueDraggable
              ...
              <ExpansiblePanel compact mark-expanded no-top-divider darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.dataLakeVariables') }}</template>
                <template #content>
                  <v-text-field
                  ...
                  >
                    <div v-for="variable in dataLakeVarsForDisplay" :key="variable" class="w-full">
                      <v-chip
                        ...
                        "
                        :title="resolveDisplayName(variable)"
                        label
              ...
              <ExpansiblePanel compact mark-expanded no-top-divider darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.customMessages') }}</template>
                <template #content>
                  <VueDraggable
                    ...
                    >
                      ...
                      >
                        <span class="text-sm font-bold text-white text-center w-full">{{
                          $t('views.ConfigurationLogsView.enterMessage')
                        }}</span>
              ...
              <ExpansiblePanel compact mark-expanded no-top-divider darken-content hover-effect>
                <template #title>{{ $t('components.TelemetryOverlay.settings') }}</template>
                <template #content>
                  <p class="text-[12px] mt-2 ml-1">{{ $t('components.TelemetryOverlay.telemetryFrequency') }}</p>
              ...
              <div class="flex justify-end w-full mt-2">
                <v-btn size="x-small" variant="text" class="mr-2" @click="resetAllChips">
                  {{ $t('components.TelemetryOverlay.resetPositions') }}
...
const translateVariable = (variable: string): string => {
  const mapping: Record<string, string> = {
    'Roll': t('components.TelemetryOverlay.variables.roll'),
    'Pitch': t('components.TelemetryOverlay.variables.pitch'),
    'Heading': t('components.TelemetryOverlay.variables.heading'),
    'Depth': t('components.TelemetryOverlay.variables.depth'),
    'Mode': t('components.TelemetryOverlay.variables.mode'),
    'Battery voltage': t('components.TelemetryOverlay.variables.batteryVoltage'),
    'Battery current': t('components.TelemetryOverlay.variables.batteryCurrent'),
    'GPS satellites': t('components.TelemetryOverlay.variables.gpsVisibleSatellites'),
    'GPS status': t('components.TelemetryOverlay.variables.gpsFixType'),
    'Latitude': t('components.TelemetryOverlay.variables.latitude'),
    'Longitude': t('components.TelemetryOverlay.variables.longitude'),
    'Mission name': t('components.TelemetryOverlay.variables.missionName'),
    'Time': t('components.TelemetryOverlay.variables.time'),
    'Date': t('components.TelemetryOverlay.variables.date'),
    'Instantaneous power': t('components.TelemetryOverlay.variables.instantaneousPower'),
...
const gridConfig: GridConfig[] = [
  { key: 'LeftTop', label: t('views.ConfigurationLogsView.gridPositions.leftTop') },
  { key: 'CenterTop', label: t('views.ConfigurationLogsView.gridPositions.centerTop') },
  { key: 'RightTop', label: t('views.ConfigurationLogsView.gridPositions.rightTop') },
  { key: 'LeftMid', label: t('views.ConfigurationLogsView.gridPositions.leftMid') },
  { key: 'CenterMid', label: t('views.ConfigurationLogsView.gridPositions.centerMid') },
  { key: 'RightMid', label: t('views.ConfigurationLogsView.gridPositions.rightMid') },
  { key: 'LeftBottom', label: t('views.ConfigurationLogsView.gridPositions.leftBottom') },
  { key: 'CenterBottom', label: t('views.ConfigurationLogsView.gridPositions.centerBottom') },
  { key: 'RightBottom', label: t('views.ConfigurationLogsView.gridPositions.rightBottom') },
]
...
const openHelpDialog = (): void => {
  showDialog({
    title: t('views.ConfigurationLogsView.videoConfigHelp'),
    message: [
      t('views.ConfigurationLogsView.videoConfigHelpDetails.telemetryConfig'),
      t('views.ConfigurationLogsView.videoConfigHelpDetails.dragAndDrop'),
      t('views.ConfigurationLogsView.videoConfigHelpDetails.moreHelp'),
    ],
    variant: 'text-only',
