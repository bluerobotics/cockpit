  ...
  <transition name="slide-in-left">
    ...
    >
      ...
      <div v-if="hasOverflow" class="overflow-indicator">
        <v-icon class="overflow-icon -mt-[12px]" :style="{ marginLeft: interfaceStore.mainMenuWidth / 2 + 'px' }"
          >mdi-arrow-up-bold</v-icon
        >
        <v-icon class="overflow-icon -mb-[12px]" :style="{ marginLeft: interfaceStore.mainMenuWidth / 2 + 'px' }"
