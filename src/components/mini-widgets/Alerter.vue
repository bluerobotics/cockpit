<template>
  ...
  <InteractionDialog
    ...
    :title="$t('components.mini-widgets.Alerter.options')"
    max-width="400px"
    variant="text-only"
  >
    <template #content>
      <div class="flex items-start justify-between flex-col -mt-8 mb-6 pl-6">
        <v-switch
          ...
          hide-details
          :label="$t('components.mini-widgets.Alerter.enableColorCodedAlerts')"
          color="white"
        />
        <v-switch
          v-model="alertStore.enableVoiceAlerts"
          hide-details
          :label="$t('components.mini-widgets.Alerter.enableVoiceAlerts')"
          color="white"
        />
        <v-slider
          ...
          hide-details
          thumb-label
          :label="$t('components.mini-widgets.Alerter.alertVolume')"
          color="white"
          class="w-[250px] mt-2"
