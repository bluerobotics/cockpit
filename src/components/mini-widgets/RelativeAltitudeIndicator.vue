<template>
  <div class="flex items-center w-fit min-w-[8rem] max-w-[10rem] h-12 p-1 text-white justify-center">
    <img src="@/assets/altitude-icon.svg" class="h-full" :draggable="false" />
    <div class="flex flex-col items-start justify-center ml-1 min-w-[4.5rem] max-w-[7rem] select-none">
