...
onBeforeMount(() => {
  ...
  // its user typed, which is what they are reading today. One left as Cockpit shipped it was never
  // the user's choice, so it follows the units they picked.
  miniWidget.value.options.useVariableUnit ??= isIndicatorAsShipped(miniWidget.value)
