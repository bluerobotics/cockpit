...
import { listenToDataLakeVariablesInfoChanges } from '@/libs/actions/data-lake'
...
// Reactively reads the selected data lake variable, auto-resubscribing when the variable changes.
