      ...
      <div v-else>
        ...
        <div class="flex flex-col align-center justify-center font-light text-slate-200 w-full h-full transition-all">
          ...
          >
            ...
            <p>
              {{ isOnEditMode ? $t('usernameDialog.deleteWarning') : $t('usernameDialog.selectOrEdit') }}
            </p>
            <br />
            ...
            <div class="fixed bottom-[6px] left-8">
              <v-switch v-model="isOnEditMode" hide-details :label="$t('usernameDialog.adminMode')" color="white" />
            </div>
          </div>
          <div v-else class="w-full h-full flex flex-col align-center justify-center">
            ...
            <v-text-field
              ...
              type="input"
              density="compact"
              :hint="$t('usernameDialog.usernameInfo')"
              class="w-[50%] m-4"
      ...
      },
      {
        ...
        action: async () => {
          try {
            ...
            openSnackbar({ message: t('usernameDialog.userDeleted'), variant: 'success' })
            ...
            try {
              ...
              openSnackbar({
                message: t('usernameDialog.deleteUserFailed'),
                variant: 'error',
                duration: 5000,
              })
            } catch (updateError) {
              openSnackbar({ message: t('usernameDialog.failedDeletingUser', { username }), variant: 'error' })
