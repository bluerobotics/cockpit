        ...
        <v-window-item v-for="step in steps" :key="step.id" :value="step.id" class="flex justify-center items-center">
          <v-timeline direction="horizontal" class="custom-timeline">
            ...
            >
              ...
              >
                <p class="text-xs">{{ $t('components.Tutorial.vehicleConnected') }}</p>
              </div>
              <template #icon>
                <v-avatar
                  size="x-large"
      ...
      <v-btn
        ...
        >{{
          interfaceStore.userHasSeenTutorial
            ? $t('components.Tutorial.showOnStartup')
            : $t('components.Tutorial.dontShowAgain')
        }}</v-btn
      >
      <v-btn
        variant="flat"
...
const steps = computed(() => [
  {
    id: 1,
    title: t('components.Tutorial.steps.1.title'),
    content: t('components.Tutorial.steps.1.content'),
    opposite: t('components.Tutorial.steps.1.opposite'),
  },
  {
    id: 2,
    title: t('components.Tutorial.steps.2.title'),
    content: t('components.Tutorial.steps.2.content'),
    opposite: t('components.Tutorial.steps.2.opposite'),
  },
  {
    id: 3,
    title: t('components.Tutorial.steps.3.title'),
    opposite: t('components.Tutorial.steps.3.opposite'),
  },
  {
    id: 4,
    title: t('components.Tutorial.steps.4.title'),
    content: t('components.Tutorial.steps.4.content'),
    opposite: t('components.Tutorial.steps.4.opposite'),
  },
  {
    id: 5,
    title: t('components.Tutorial.steps.5.title'),
    content: t('components.Tutorial.steps.5.content'),
    opposite: t('components.Tutorial.steps.5.opposite'),
  },
  {
    id: 6,
    title: t('components.Tutorial.steps.6.title'),
    opposite: t('components.Tutorial.steps.6.opposite'),
  },
  {
    id: 7,
    title: t('components.Tutorial.steps.7.title'),
    content: t('components.Tutorial.steps.7.content'),
    opposite: t('components.Tutorial.steps.7.opposite'),
  },
  {
    id: 8,
    title: t('components.Tutorial.steps.8.title'),
    content: t('components.Tutorial.steps.8.content'),
    opposite: t('components.Tutorial.steps.8.opposite'),
  },
  {
    id: 9,
    title: t('components.Tutorial.steps.9.title'),
    opposite: t('components.Tutorial.steps.9.opposite'),
  },
  {
    id: 10,
    title: t('components.Tutorial.steps.10.title'),
    opposite: t('components.Tutorial.steps.10.opposite'),
  },
  {
    id: 11,
    title: t('components.Tutorial.steps.11.title'),
    content: t('components.Tutorial.steps.11.content'),
    opposite: t('components.Tutorial.steps.11.opposite'),
  },
  {
    id: 12,
    title: t('components.Tutorial.steps.12.title'),
    opposite: t('components.Tutorial.steps.12.opposite'),
  },
  {
    id: 13,
    title: t('components.Tutorial.steps.13.title'),
    content: t('components.Tutorial.steps.13.content'),
    opposite: t('components.Tutorial.steps.13.opposite'),
  },
])
...
const dontShowTutorialAgain = (): void => {
  ...
  openSnackbar({
    message: t('info.tutorialReopenInfo'),
    variant: 'info',
    closeButton: true,
    duration: 5000,
  })
