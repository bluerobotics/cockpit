    ...
    <div class="flex flex-col justify-between h-full pa-2 cursor-pointer">
      <div class="flex justify-between w-full">
        ...
        <div v-if="!isWrapped">
          ...
          <p v-else @dblclick="enableEditing">{{ widget.name }}</p>
        </div>
        <div class="flex">
        ...
        >
          <div v-for="container in leftContainers" :key="container.name" class="w-full h-full">
            ...
            >
              ...
              >
                <CustomWidgetInstantiator :element="miniWidget" />
              </div>
            </VueDraggable>
          </div>
        </div>
...
import CustomWidgetInstantiator from '@/components/CustomWidgetElementInstantiator.vue'
import { useSnackbar } from '@/composables/snackbar'
import { useAppInterfaceStore } from '@/stores/appInterface'
import { useWidgetManagerStore } from '@/stores/widgetManager'
import { CustomWidget, CustomWidgetElement, CustomWidgetElementContainer, Widget } from '@/types/widgets'
