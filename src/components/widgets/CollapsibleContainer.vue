          ...
          <v-menu v-if="widgetStore.editingMode" theme="dark">
            ...
            <v-list>
              <v-list-item @click="handleOptionClick('options')">
                <v-list-item-title>{{ $t('components.widgets.CollapsibleContainer.options') }}</v-list-item-title>
              </v-list-item>
              ...
              <v-list-item @click="handleOptionClick('load')">
                <v-list-item-title>{{ t('components.widgets.CollapsibleContainer.load') }}</v-list-item-title>
              </v-list-item>
              <v-list-item @click="handleOptionClick('copy-to-view')">
                <v-list-item-title>{{
                  $t('components.widgets.CollapsibleContainer.cloneToAnotherView')
                }}</v-list-item-title>
              </v-list-item>
            </v-list>
          </v-menu>
      ...
      <GlassModal :is-visible="widgetStore.widgetManagerVars(widget.hash).configMenuOpen">
        <v-card class="px-8 pb-6 pt-2 rounded-lg w-[400px] bg-transparent">
          <v-card-title class="text-center -mt-1">{{
            $t('components.widgets.CollapsibleContainer.customWidgetOptions')
          }}</v-card-title>
          <v-btn
          ...
          <div class="flex flex-col justify-start items-start gap-x-4 mt-3 w-full">
            <p class="text-start">{{ $t('components.widgets.CollapsibleContainer.name') }}</p>
            ...
            <v-text-field
              ...
              class="w-1/4"
            />
            <p class="mt-1">{{ $t('components.widgets.CollapsibleContainer.backgroundColor') }}</p>
            <input v-model="widget.options.backgroundColor" type="color" class="p-0 w-20 mr-4" />
            <p class="mt-3">{{ $t('components.widgets.CollapsibleContainer.backgroundOpacity') }}</p>
            <v-slider
              ...
              width="250"
            />
            <p class="mt-3">{{ $t('components.widgets.CollapsibleContainer.backgroundBlur') }}</p>
      ...
      <GlassModal :is-visible="selectViewToShareDialog">
        <v-card class="px-3 pb-6 pt-2 rounded-lg w-auto bg-transparent z-40">
          <v-card-title class="flex justify-around -mt-1 w-full px-0">
            <div />
            <p class="mx-8">{{ $t('components.widgets.CollapsibleContainer.cloneWidgetTo') }}</p>
