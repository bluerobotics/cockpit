<template>
  ...
  <v-dialog v-model="widgetStore.widgetManagerVars(widget.hash).configMenuOpen" min-width="400" max-width="45%">
    <v-card class="pa-4" :style="interfaceStore.globalGlassMenuStyles" style="border-radius: 15px">
      <v-card-title class="text-center">{{ $t('components.widgets.Attitude.widgetConfig') }}</v-card-title>
      <v-card-text>
        <div class="flex justify-center gap-x-8 mb-4">
          <v-switch
            class="ma-1"
            :label="$t('components.widgets.Attitude.showRollPitchValues')"
          ...
          <v-switch
            class="ma-1"
            :label="$t('components.widgets.Attitude.showCenterAim')"
          ...
          <v-switch
            class="ma-1"
            :label="$t('components.widgets.Attitude.showPitchLines')"
        ...
        <v-slider
          ...
          color="white"
          :label="$t('components.widgets.Attitude.cameraVerticalFOV')"
          :min="20"
          :max="180"
          thumb-label
        />
        <v-slider
          ...
          :label="$t('components.widgets.Attitude.centerCircleRadius')"
          color="white"
          :min="10"
          :max="300"
          thumb-label
