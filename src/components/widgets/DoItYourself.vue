    ...
    <vue-draggable-resizable :drag-handle="'.drag-handle'" w="auto" h="auto" :handles="['tm', 'mr', 'bm', 'ml']">
      <v-card class="pa-2" :style="interfaceStore.globalGlassMenuStyles">
        ...
        <v-card-title class="w-full text-center mt-2">{{
          $t('components.widgets.doItYourself.widgetConfiguration')
        }}</v-card-title>
        <v-card-text class="mx-2 flex flex-col gap-y-3">
          <v-expand-transition>
            <div v-if="showHelp" class="help-panel mb-4 p-4 rounded bg-white/5">
              <h3 class="text-lg mb-2">{{ $t('components.widgets.doItYourself.editorInstructions') }}</h3>
              <ul class="text-sm text-white/70 list-disc pl-4 space-y-1">
                <li>{{ $t('components.widgets.doItYourself.instruction1') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction2') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction3') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction4') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction5') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction6') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction7') }}</li>
                <li>{{ $t('components.widgets.doItYourself.instruction8') }}</li>
              </ul>
            </div>
          </v-expand-transition>
          ...
          <v-checkbox
            v-model="autoSave"
            :label="$t('components.widgets.doItYourself.autoSave')"
            density="compact"
            class="-mb-2"
            hide-details
          />
          <v-checkbox
            ...
            :label="$t('components.widgets.doItYourself.inheritStyles')"
            density="compact"
            class="-mb-2"
            hide-details
          />
        ...
        <v-card-actions>
          <div class="flex justify-between items-center px-4 w-full h-full">
            <v-btn class="text-white/60" variant="text" @click="closeDialog">{{ $t('common.close') }}</v-btn>
            <div class="flex gap-x-3">
              <v-btn
                class="text-white/60"
                variant="text"
                :title="$t('components.widgets.doItYourself.exportConfig')"
                @click="exportConfig"
              >
                <v-icon class="mr-1 mt-[2px]">mdi-download</v-icon>
                {{ $t('components.widgets.doItYourself.export') }}
              </v-btn>
              <v-btn
                class="text-white/60 mr-10"
                variant="text"
                :title="$t('components.widgets.doItYourself.importConfig')"
                @click="importConfig"
              >
                <v-icon class="mr-1 mt-[2px]">mdi-upload</v-icon>
                {{ $t('components.widgets.doItYourself.import') }}
              </v-btn>
...
<div id="diy-container">
  <span>{{ $t('components.widgets.doItYourself.createYourOwn') }}</span>
</div>`,
