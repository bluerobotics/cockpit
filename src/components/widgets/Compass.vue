<template>
  ...
  >
    <div class="flex items-center">
      <span class="mr-3 text-slate-100">{{ $t('components.widgets.Compass.headingStyle') }}</span>
...
const headingOptions = computed(() => [t('components.widgets.Compass.northUp'), t('components.widgets.Compass.headUp')])
...
const renderCanvas = (): void => {
  ...
  if (widget.value.options.headingStyle == t('components.widgets.Compass.headUp')) {
