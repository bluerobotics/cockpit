        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="text-xs text-gray-400">
              ...
              Type <code>&#123;&#123;</code> to access available variables. Return is optional, but should be included
          ...
          <v-textarea
            ...
            hide-details
          />
          <v-btn v-if="!showDescription" block variant="text" @click="isDescriptionFieldVisible = true">
            Add description about this variable
          </v-btn>
        </div>
      </v-card-text>
...
const isDescriptionFieldVisible = ref(false)

const showDescription = computed(() => {
  const hasDescription = newFunction.value.description && newFunction.value.description.trim() !== ''
  return isDescriptionFieldVisible.value || hasDescription
})
...
const closeDialog = (): void => {
  ...
  isDescriptionFieldVisible.value = false
}
