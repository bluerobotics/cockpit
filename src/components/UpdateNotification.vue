  ...
  >
    <template #content>
      <div v-if="updateInfo" class="mt-2">
        <strong>{{ $t('components.UpdateNotification.updateDetails') }}:</strong>
...
onBeforeMount(() => {
  ...
  window.electronAPI.onCheckingForUpdate(() => {
    ...
    dialogTitle.value = t('components.UpdateNotification.checkingForUpdates')
    dialogMessage.value = t('components.UpdateNotification.checkingMessage')
  ...
  window.electronAPI.onUpdateNotAvailable(() => {
    ...
    dialogTitle.value = t('components.UpdateNotification.noUpdatesAvailable')
    dialogMessage.value = t('components.UpdateNotification.noUpdatesMessage')
  ...
  window.electronAPI.onUpdateAvailable((info) => {
    ...
    dialogTitle.value = t('components.UpdateNotification.updateAvailable')
    dialogMessage.value = t('components.UpdateNotification.updateAvailableMessage')
    dialogVariant.value = 'info'
    updateInfo.value = { ...info }
    dialogActions.value = [
      {
        text: t('components.UpdateNotification.ignoreThisVersion'),
        action: () => {
      ...
      {
        text: t('components.UpdateNotification.download'),
        action: () => {
          ...
          dialogActions.value = [
            {
              ...
              action: () => {
                ...
                window.electronAPI!.cancelUpdate()
                showUpdateDialog.value = false
                dialogMessage.value = t('components.UpdateNotification.downloadingUpdate')
              },
            },
          ]
        },
      ...
      {
        text: t('components.UpdateNotification.notNow'),
        action: () => {
          window.electronAPI!.cancelUpdate()
          showUpdateDialog.value = false
        },
  ...
  window.electronAPI.onUpdateDownloaded(() => {
    ...
    dialogTitle.value = t('components.UpdateNotification.updateReadyToInstall')
    dialogMessage.value = t('components.UpdateNotification.updateDownloadedMessage')
    dialogVariant.value = 'info'
    showProgress.value = false
    dialogActions.value = [
      {
        text: t('components.UpdateNotification.installNow'),
        action: () => {
      ...
      {
        text: t('components.UpdateNotification.later'),
        action: () => {
