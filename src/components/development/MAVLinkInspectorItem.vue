  ...
  <div class="mb-4">
    <div class="font-bold mb-2 flex items-center justify-between">
      ...
      <button
        ...
        :title="$t('Stop tracking this message')"
