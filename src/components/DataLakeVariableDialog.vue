  ...
  <v-dialog :model-value="modelValue" max-width="560px" @update:model-value="emit('update:modelValue', $event)">
    <v-card class="rounded-lg" :style="interfaceStore.globalGlassMenuStyles">
      <v-card-title class="text-h6 font-weight-bold py-4 text-center">
        {{ editMode ? $t('dataLake.editVariable') : $t('dataLake.newVariable') }}
      </v-card-title>
      <v-card-text class="px-8">
        <div class="flex flex-col gap-4">
          ...
          />
          <div class="flex items-center gap-2">
            <label class="text-sm">{{ $t('dataLake.variableType') }}: </label>
            <v-radio-group
              ...
              inline
            >
              <v-radio class="ml-3 mr-4" :label="$t('dataLake.types.string')" value="string" />
              <v-radio class="ml-3 mr-4" :label="$t('dataLake.types.number')" value="number" />
              <v-radio class="ml-3 mr-4" :label="$t('dataLake.types.boolean')" value="boolean" />
            </v-radio-group>
          </div>
          <v-text-field
          ...
          <v-textarea
            ...
            variant="outlined"
            :placeholder="$t('dataLake.descriptionPlaceholder')"
            rows="1"
            density="compact"
            hide-details
          />
          <v-checkbox
            ...
            :label="$t('dataLake.persistBetweenBoots')"
            hide-details
            class="-mb-4 -mt-2"
          />
          <v-checkbox
            ...
            class="-my-4"
            hide-details
            :label="$t('dataLake.saveValueBetweenBoots')"
