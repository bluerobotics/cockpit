    ...
    <template #content>
      <div class="flex items-center justify-center mb-2">
        ...
        <div class="flex flex-col font-medium gap-y-3 w-full">
          ...
          <ul class="mt- ml-4">
            <li>- Three to four times slower application startup times</li>
            <li>- Double the memory usage</li>
            <li>- Reduced overall performance</li>
          </ul>
          <p class="text-sm text-gray-600 mt-2">
            We find the performance decrease to be so so severe that we will keep warning you until you download and
