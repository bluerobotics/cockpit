                ...
                >
                  ...
                  >
                    <div class="flex flex-col p-2 gap-y-2">
                      <div>
                        <strong>{{ $t('videoLibrary.computer') }}:</strong> {{ $t('videoLibrary.computerMultiSelect') }}
                      </div>

                      <div><strong>{{ $t('videoLibrary.mobile') }}:</strong> {{ $t('videoLibrary.mobileMultiSelect') }}</div>
                    </div>
                  </v-tooltip>
                </button>
              </div>
                ...
                <div>
                  <v-btn variant="text" size="small" class="mt-[5px]" @click="toggleSelectionMode">
                    <v-tooltip open-delay="500" activator="parent" location="bottom">
                      {{ isMultipleSelectionMode ? $t('videoLibrary.selectSingleFiles') : $t('videoLibrary.selectMultipleFiles') }}
                    </v-tooltip>
                    {{ isMultipleSelectionMode ? $t('videoLibrary.singleSelection') : $t('videoLibrary.multiSelection') }}
                  </v-btn>
                  <v-btn
                    variant="text"
                    size="small"
                  ...
                  >
                    <v-tooltip open-delay="500" activator="parent" location="bottom">
                      {{ selectedPicSet.size === availablePictures.length ? $t('videoLibrary.selectNone') : $t('videoLibrary.selectAllFiles') }}
                    </v-tooltip>
                  ...
                  <div class="flex flex-col h-full">
                    <div class="mx-5 pt-4">
                      <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">{{ $t('videoLibrary.processedVideos') }}</h3>
                        <div class="flex items-center gap-4">
                          <span class="text-sm text-white/70">{{ $t('videoLibrary.finalVideosWithTelemetry') }}</span>
                        </div>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          <div class="flex-1 ml-4">
                            <div class="font-medium text-white">
                              {{ parseDateFromTitle(video.fileName) || $t('videoLibrary.cockpitVideo') }}
                            </div>
                          ...
                          <div class="flex items-center gap-2 ml-4">
                            ...
                            >
                              <v-tooltip open-delay="500" activator="parent" location="bottom"> {{ $t('videoLibrary.playVideo') }} </v-tooltip>
                ...
                <template v-if="currentVideoSubTab === 'raw'">
                  <div v-if="!isElectron()" class="flex flex-col h-full">
                    ...
                    <div class="px-4 pt-6 pb-3">
                      <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">{{ $t('videoLibrary.rawVideoChunks') }}</h3>
                        <div
                          class="flex items-center gap-2 cursor-pointer"
                          @click="isInstructionsExpanded = !isInstructionsExpanded"
                        >
                          <span class="text-sm text-white/70">{{ $t('videoLibrary.browserVersionInstructions') }}</span>
                          <v-icon
                        ...
                        >
                          <div class="flex items-start gap-3">
                            ...
                            <div class="text-white/80 text-sm space-y-1">
                              <p>
                                {{ $t('videoLibrary.rawChunksInfo') }}
                              </p>
                              <div>
                                <p class="font-medium mb-2">{{ $t('videoLibrary.toProcessYourVideos') }}</p>
                                <ol class="space-y-0">
                                  <li class="flex items-start gap-2">
                                    <span class="text-white font-bold">1.</span>
                                    <span>{{ $t('videoLibrary.downloadChunksStep') }}</span>
                                  </li>
                                  <li class="flex items-start gap-2">
                                    <span class="text-white font-bold">2.</span>
                                    <span>{{ $t('videoLibrary.openStandaloneStep') }}</span>
                                  </li>
                                  <li class="flex items-start gap-2">
                                    <span class="text-white font-bold">3.</span>
                                    <span>{{ $t('videoLibrary.goToProcessingTabStep') }}</span>
                                  </li>
                                  <li class="flex items-start gap-2">
                                    <span class="text-white font-bold">4.</span>
                                    <span>{{ $t('videoLibrary.selectAndProcessStep') }}</span>
                                  </li>
                                  <li class="flex items-start gap-2">
                                    <span class="text-white font-bold">5.</span>
                                    <span>{{ $t('videoLibrary.deleteChunksStep') }}</span>
                                  </li>
                                </ol>
                              </div>
                            </div>
                    ...
                    <div v-else class="flex flex-col justify-center items-center flex-1 text-center px-4">
                      <div class="max-w-md mx-auto">
                        <template v-if="chunkLoadingData">
                          ...
                          <h4 class="text-lg font-medium text-white mb-2">{{ $t('videoLibrary.loadingChunks') }}</h4>
                          <p class="text-white/70 text-sm">{{ $t('videoLibrary.countingChunks') }}</p>
                        </template>
                        <template v-else>
                    ...
                    <div v-if="chunkGroups.length > 0" class="flex flex-col h-full">
                      ...
                      <div class="mx-5 pt-4">
                        <div class="flex justify-between items-center mb-4">
                          ...
                          <div class="flex items-center gap-4">
                            <span class="text-sm text-white/70">{{ $t('videoLibrary.backupRawData') }}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="flex flex-col justify-center items-center flex-1 text-center px-4">
                        <div class="max-w-md mx-auto">
                          ...
                          <template v-else>
                            ...
                            <p class="text-white/70 text-sm">{{ $t('videoLibrary.startRecording') }}</p>
                          </template>
                        </div>
                      </div>
                ...
                <template v-if="currentVideoSubTab === 'processing'">
                  <div class="flex flex-col h-full">
                    ...
                    <div class="flex-1 overflow-y-auto px-4 py-6">
                      <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">{{ $t('videoLibrary.processZipFilesTitle') }}</h3>
                        <div class="flex items-center gap-4">
                          <span class="text-sm text-white/70">{{ $t('videoLibrary.processRawChunksFromWeb') }}</span>
                        </div>
                      </div>
                      ...
                      <div v-if="isProcessingZip" class="bg-blue-900/30 border border-blue-500/30 rounded-lg p-4 mb-4">
                        <div class="flex items-center gap-3 mb-3">
                          ...
                          <span class="text-blue-200 font-medium">{{ $t('videoLibrary.processingZip') }}</span>
                        </div>
                      ...
                      >
                        <div class="text-center">
                          ...
                          <h4 class="text-lg font-medium text-white mb-2">{{ $t('videoLibrary.processZipFile') }}</h4>
                          <p class="text-white/70 text-sm mb-4">
                            {{ $t('videoLibrary.selectZipDescription') }}
                          </p>
                          <v-btn variant="outlined" size="large" @click="handleProcessVideoChunksZip">
                            <v-icon class="mr-2">mdi-folder-open</v-icon>
                            {{ $t('videoLibrary.selectAndProcessZip') }}
                          </v-btn>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="px-4 py-3 border-t mb-4 border-white/10">
                      <div class="flex items-start gap-3">
                        ...
                        <div class="flex flex-col w-full">
                          <h4 class="text-white font-medium mb-3">{{ $t('videoLibrary.processingInstructions') }}</h4>
                          <ol class="text-white/80 text-sm space-y-2">
                            <li class="flex items-start gap-2">
                              <span class="text-white font-bold">1.</span>
                              <span>{{ $t('videoLibrary.downloadFromRawTab') }}</span>
                            </li>
                            <li class="flex items-start gap-2">
                              <span class="text-white font-bold">2.</span>
                              <span>{{ $t('videoLibrary.selectZipFile') }}</span>
                            </li>
                            <li class="flex items-start gap-2">
                              <span class="text-white font-bold">3.</span>
                              <span>{{ $t('videoLibrary.clickProcessZip') }}</span>
                            </li>
                            <li class="flex items-start gap-2">
                              <span class="text-white font-bold">4.</span>
                              <span>{{ $t('videoLibrary.videoAppearsInTab') }}</span>
                            </li>
                          </ol>
                        </div>
                      </div>
...
const videoSubTabs = [
  ...
  },
  {
    ...
    disabled: false,
    tooltip: t('videoLibrary.manageRawChunks'),
  },
  {
    name: 'processing',
    label: 'Processing',
    ...
    disabled: !isElectron(),
    tooltip: isElectron() ? t('videoLibrary.processZipFiles') : t('videoLibrary.onlyAvailableStandalone'),
  },
]
