...
onMounted(() => {
  refreshAllParams()
  vehicleStore.mainVehicle?.onIncomingMAVLinkMessage.add(MAVLinkType.PARAM_VALUE, onParamValueMessage)
})

onBeforeUnmount(() => {
  vehicleStore.mainVehicle?.onIncomingMAVLinkMessage.remove(MAVLinkType.PARAM_VALUE, onParamValueMessage)
})
