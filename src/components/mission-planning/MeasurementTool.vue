<template>
  <v-tooltip location="top center" :text="props.isActive ? 'End Measure Mode' : 'Measure Mode'">
    <template #activator="{ props: tooltipProps }">
      <v-btn
        v-bind="tooltipProps"
        class="absolute m-3 rounded-sm shadow-sm bottom-12 right-[134px] text-[14px]"
...
import { bearingToCompassDirection, calculateSnappedPosition } from '@/libs/map/utils-map'
import {
  bearingBetween,
