      ...
      >
        ...
        <v-list-item class="flex items-center gap-x-2 pb-2" @click="handlePlacePointOfInterest">
          <v-icon
            ...
            class="text-[16px]"
          ></v-icon>
          <span class="text-white text-sm ml-4">{{ t('components.widgets.Map.placePointOfInterest') }}</span>
        </v-list-item>
        <v-divider />
        ...
        <v-list-item class="flex items-center gap-x-2 pb-2" @click="handleClearVehiclePathHistory">
          <v-icon
            ...
            class="text-[16px]"
          ></v-icon>
          <span class="text-white text-sm ml-4">{{ t('missionPlanning.clearVehiclePathHistory') }}</span>
        </v-list-item>
      </div>
    </div>
