...
export const useFenceRendering = (props: FenceRenderingProps): void => {
  ...
  // A handle drag holds the map itself hostage — panning is disabled and the
  // move/up handlers live on the map, which outlives this overlay — so the
  // release is kept reachable for the teardown below.
